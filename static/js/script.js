var LANGUAGES = {
    ...
    "en": {
        ...
        texts: {
            ...
            "access-via-mirror": "Congratulations! You are using a mirror site, which should speed up access within China (Mainland) and some regions. Click here to <a href='https://hunglunna.github.io/hunglunnacute/'>visit the source site on GitHub Pages</a>.",
            "show-credits-text": "Show Credits",
            "show-options-text": "Setting",
            "repository-desc": "Website profile",
        ...
        texts: {
            ...
            "access-via-mirror": "恭喜！你正在使用镜像站，这应当会加速在中国大陆及部分地区境内的访问。点此<a href='https://hunglunna.github.io/hunglunnacute/'>访问 GitHub Pages 上的源站</a>。",
            "show-credits-text": "查看感谢页",
            "show-options-text": "环境",
            "repository-desc": "网站简介",
        ...
        texts: {
            ...
            "access-via-mirror": "你目前正在使用鏡像網站，若是從中國大陸和其他區域來的存取，或多或少會變流暢。請點擊此處 <a href='https://hunglunna.github.io/hunglunnacute/'> 訪問 GitHub Pages 上的原始網站</a>。",
            "show-credits-text": "顯示製作人員",
            "show-options-text": "環境",
            "repository-desc": "網站簡介",
        ...
        texts: {
            ...
            "access-via-mirror": "おめでとうございます！今はもうミラーサイトを使っています、中国大陸まだは他の地域のアクセス速度が速くなります。サイトのソースを見たいなら、<a href='https://hunglunna.github.io/hunglunnacute/'>ここにクリックして</a>、GitHubページで見てください。",
            "show-credits-text": "クレジットを表示",
            "show-options-text": "設定",
            "repository-desc": "ウェブサイトのプロフィール",
            "options-txt-vo-lang": "Voice-Over Language",
    ...
    "kr": {
        ...
        texts: {
            ...
            "access-via-mirror": "축하합니다. 현재 미러 사이트를 통해 접속하고 있습니다. 이 사이트에선 중국 본토 및 일부 지역에서의 액세스 속도가 빨라집니다. <a href='https://hunglunna.github.io/hunglunnacute/'>여기를 클릭하여 GitHub Pages에 접속하세요</a>.",
            "show-credits-text": "크레딧 표시",
            "show-options-text": "設定",
            "repository-desc": "웹사이트 프로필",
            "options-txt-vo-lang": "Voice-Over Language",
    ...
    "id": {
        ...
        texts: {
            ...
            "access-via-mirror": "Selamat! Kamu sedang menggunakan situs mirror, yang mana seharusnya mempercepat akses untuk wilayah sekitar Tiongkok (daratan) dan wilayah lainnya . Silakan klik <a href='https://hunglunna.github.io/hunglunnacute/'> di sini untuk mengunjungi situs sumbernya pada Laman Github</a>.",
            "show-credits-text": "menunjukkan kredit",
            "show-options-text": "pengaturan",
            "repository-desc": "Profil situs web",
            "options-txt-vo-lang": "Voice-Over Language",
    ...
    "pt": {
        ...
        texts: {
            ...
            "access-via-mirror": "Parabéns! Você está usando um site espelho, o que deve acelerar o acesso na China (continente) e algumas regiões. Clique aqui para <a href='https://hunglunna.github.io/hunglunnacute/'>visitar o site de origem no GitHub Pages</a>.",
            "show-credits-text": "mostrar crédito",
            "show-options-text": "arranjo",
            "repository-desc": "Perfil do site",
        ...
        texts: {
            ...
            "access-via-pages": "You're currently accessing via GitHub Pages. For users in China (Mainland) or some other regions, click <a href='https://herta.ft2.ltd/'>here to access the mirror on Netlify</a>. ",
            "access-via-mirror": "Congratulations! You are using a mirror site, which should speed up access within China (Mainland) and some regions. Click here to <a href='https://hunglunna.github.io/hunglunnacute/'>visit the source site on GitHub Pages</a>.",
            "show-credits-text": "show credit",
            "show-options-text": "arrangement",
            "repository-desc": "Website profile",
        ...
        texts: {
            ...
            "access-via-mirror": "Chúc mừng! bạn đang sử dụng bản sao, tăng tốc độ truy cập trong Trung Quốc Đại Lục và một số khu vực khác. Click tại <a href='https://hunglunna.github.io/hunglunnacute/'>đây để ghé thăm trang nguồn tại GitHub Pages</a>.",
